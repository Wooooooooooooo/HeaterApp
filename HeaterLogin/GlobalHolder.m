...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.backgroundColdColor = [UIColor colorWithRed:244 / 255.0 green:113 / 255.0 blue:103 / 255.0 alpha:0];
        //    self.backgroundWarmColor = [UIColor colorWithRed:244 / 255.0 green:113 / 255.0 blue:103 / 255.0 alpha:1];
        self.backgroundWarmColor = [UIColor colorWithRed:244 / 255.0 green:113 / 255.0 blue:103 / 255.0 alpha:0];
    }
    return self;
}
